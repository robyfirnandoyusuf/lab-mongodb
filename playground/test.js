...
//RUN: node ./node_modules/mocha/bin/mocha playground/test.js
...
describe('sanitize', function () {
    ...
    it('should remove fields that contain a single quote from objects', function () {
        // { 'field': 5 } -> {}
        var obj = { username: "pwn'" };
        assert.deepEqual(sanitize(obj), { username: 'pwn' });
